...
<head>
    ...
    <title>Tarjeta de Presentación Digital - Juan Carlos Salamanca</title>
...
<body class="flex items-center justify-center min-h-screen sm:p-4">
    ...
    <div class="w-full sm:max-w-sm mx-auto bg-white rounded-none sm:rounded-3xl overflow-hidden relative shadow-2xl">
        ...
        <a href="tel:+573174895737" title="Llamar" class="absolute top-4 right-4 z-20 w-12 h-12 bg-black/20 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center text-white social-icon transition-colors duration-300" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.5);">
        ...
        <div class="relative text-center pb-8 bg-white">
            ...
            <div class="absolute top-0 left-0 w-full h-[320px]">
                <img src="[https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto-format&fit=crop](https://i.postimg.cc/s2kS2mNt/IMG-20240308-WA0005-(1).jpg)" 
                     alt="Foto de Juan Carlos Salamanca" 
        ...
        <div class="p-6 pt-4 space-y-5 bg-white rounded-b-3xl">
            ...
            <!-- Botón 1: Atención -->
            <a href="https://wa.me/3174895737" target="_blank" class="relative flex items-center h-14 rounded-full gold-gradient button-3d group transition-transform duration-150 ease-in-out">
            ...
            <!-- Botón 4: Ubicación -->
            <a href="[https://www.google.com/maps/search/?api=1&query=South+Beach,+Miami" target="_blank" class="relative flex items-center h-14 rounded-full gold-gradient button-3d group transition-transform duration-150 ease-in-out](https://maps.app.goo.gl/aKYzN2rpsV6gApRw6)">
                <div class="absolute left-0 top-1/2 -translate-y-1/2 w-16 h-16 rounded-full flex items-center justify-center icon-bg">
            ...
            <div class="text-center pt-4 border-t border-gray-100 mt-5">
                <a href="mailto:juansam3@gmail.com" class="text-gray-500 hover:name-color transition-colors duration-300 inline-flex items-center space-x-2 text-sm">
                    <i class="fas fa-envelope"></i>
                    <span>juansam3@gmail.com</span>
                </a>
